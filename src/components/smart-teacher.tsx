...
import { Send, Loader2, GraduationCap, FileText, Sparkles, BookOpen, List, Repeat, ChevronsUpDown, Puzzle, VenetianMask, MessageSquareWarning, PencilRuler } from 'lucide-react';
                 ...
                 <AccordionItem value={`item-${index}`} key={index}>
                    ...
                    <AccordionContent className="space-y-4 px-2">
                      ...
                      <div className="bg-muted p-3 rounded-md">
                        <p className="font-mono text-md">"{item.example}"</p>
                        <p className="text-sm text-muted-foreground">{item.exampleTranslation}</p>
                      </div>
                    </AccordionContent>
                </AccordionItem>
